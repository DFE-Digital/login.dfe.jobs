...
const govNotifyEmailTemplatesSchema = new SimpleSchema({
  ...
  userRequestForOrganisationAccessApprovedToApprovers: String,
  userRequestForOrganisationAccessRejectedToApprovers: String,
  userRequestForServiceApprovedV1: String,
  userRequestForServiceApprovedV2: String,
  userRequestForServiceRejected: String,
  userRequestForServiceApprovedToApprovers: String,
  userRequestForServiceRejectedToApprovers: String,
  userRequestsForSubServicesApproved: String,
  userRequestsForSubServicesRejected: String,
  userRequestForSubServicesApprovedToApprovers: String,
  userRequestForSubServicesRejectedToApprovers: String,
