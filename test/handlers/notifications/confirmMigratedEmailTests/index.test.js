jest.mock('../../../../src/handlers/notifications/confirmMigratedEmail/confirmMigratedEmailV1');
...
describe('when registering confirmMigratedEmail handlers', () => {
  ...
  beforeAll(() => {
    v1 = require('../../../../src/handlers/notifications/confirmMigratedEmail/confirmMigratedEmailV1');
    v1.getHandler = jest.fn().mockReturnValue({
      type: 'v1',
      processor,
    });

    register = require('../../../../src/handlers/notifications/confirmMigratedEmail/').register;
  });
