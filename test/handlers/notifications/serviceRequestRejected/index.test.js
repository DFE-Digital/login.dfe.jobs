jest.mock('../../../../src/handlers/notifications/serviceRequestRejected/rejectServiceV1');
...
describe('when registering service request rejected handlers', () => {
  ...
  beforeAll(() => {
    v1 = require('../../../../src/handlers/notifications/serviceRequestRejected/rejectServiceV1');
    v1.getHandler = jest.fn().mockReturnValue({
      type: 'v1',
      processor,
    });

    register = require('../../../../src/handlers/notifications/serviceRequestRejected').register;
  });
