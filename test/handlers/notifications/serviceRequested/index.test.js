jest.mock('../../../../src/handlers/notifications/serviceRequested/serviceRequestToApproversV2');
...
describe('when registering service added handlers', () => {
  ...
  beforeAll(() => {
    ...
    register = require('../../../../src/handlers/notifications/serviceRequested').register;
  });
