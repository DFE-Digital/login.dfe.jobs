...
const {
  getHandler,
} = require("../../../../src/handlers/notifications/subServiceRequestActioned/subServiceRequestOutcomeToApprovers");
...
describe("when processing a subServiceRequestOutcomeToApprovers job", () => {
  ...
  it("should return a handler with a processor", async () => {
    ...
    expect(handler.type).toBe("sub_service_request_outcome_to_approvers");
