jest.mock('../../../../src/handlers/notifications/unmigratedSaUser/unmigratedSaUserV1');
...
describe('when registering unmigrated SA User handlers', () => {
  ...
  beforeAll(() => {
    v1 = require('../../../../src/handlers/notifications/unmigratedSaUser/unmigratedSaUserV1');
    v1.getHandler = jest.fn().mockReturnValue({
      type: 'v1',
      processor,
    });

    register = require('../../../../src/handlers/notifications/unmigratedSaUser').register;
  });
