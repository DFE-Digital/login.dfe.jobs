jest.mock('../../../../src/handlers/notifications/userOrganisation/exsitingUserAddedToOrgV1');
jest.mock('../../../../src/handlers/notifications/userOrganisation/removedUserFromOrgV1');
...
describe('when registering user organisation handlers', () => {
  ...
  beforeAll(() => {
    ...
    register = require('../../../../src/handlers/notifications/userOrganisation').register;
  });
