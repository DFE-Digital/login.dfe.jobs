...
const { getAllApplicationRequiringNotification, enqueue } = require('../../../../src/handlers/serviceNotifications/utils');
const { getDefaultConfig, getLoggerMock } = require('../testUtils');
const { getHandler } = require('../../../../src/handlers/serviceNotifications/roles/roleUpdatedHandlerV1');
