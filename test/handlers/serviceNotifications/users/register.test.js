jest.mock('../../../../src/handlers/serviceNotifications/users/userUpdatedHandlerV1');
jest.mock('../../../../src/handlers/serviceNotifications/users/sendWSUserUpdatedV1');
...
const { register } = require('../../../../src/handlers/serviceNotifications/users');
