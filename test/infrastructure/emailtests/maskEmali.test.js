...
describe("When attempting to mask an email in a non-audit log", () => {
  it("correctly masks characters except the first and last in the email username, if it is an email-like string", () => {
    expect(maskEmail("testing@education.gov.uk")).toBe(
      "t*****g@education.gov.uk",
    );
    expect(maskEmail("testing123@education.gov.uk")).toBe(
      "t********3@education.gov.uk",
    );
    expect(maskEmail("testing.email123@education.gov.uk")).toBe(
      "t**************3@education.gov.uk",
    );
    expect(maskEmail("testing.email_123@education.gov.uk")).toBe(
      "t***************3@education.gov.uk",
    );
    expect(maskEmail("testing.email+123@education.gov.uk")).toBe(
      "t***************3@education.gov.uk",
    );
  });
